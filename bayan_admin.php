                        ...
                        <div class="header-left">
                            <div class="search_bar dropdown">
                                ...
                                <div class="dropdown-menu p-0 m-0">
                                    <form method="POST">
                                        <input dir="rtl" class="form-control" name="search_to_show" type="search" placeholder="ابحث هنا عن بيان ..." aria-label="Search">
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="./table-datatable-basic.php">
            ...
            <div class="col-12">
                        <div class="card">
                            <div class="card-header" style="display: flex; align-items: center; justify-content: space-around;">
                                ...
                                <h4 class="card-title"><a class="text-danger" href="./bayan_admin.php">انقر هنا لإغلاق البحث <i class="fa-solid fa-xmark"></i></a></h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        ?>
                                            <tr style="text-align: center;">
                                                <?php
                                                    ...
                                                    if($row['BAYAN_FILE'] != null){echo '<td><a href="./declarations/' . $row['BAYAN_FILE'] . '" style="color: brown; font-size: 1.5em;" title="Download" download><i class="fa-solid fa-download"></i> </a><a href="./declarations/' . $row['BAYAN_FILE'] . '" style="color: brown; font-size: 1.5em;" target="_blank" title="View"> <i class="fa-solid fa-eye"></i></a></td>';} else {echo '<td>-</td>';}  
                                                ...
                                                <div style="display: flex; align-items:center; justify-content:space-between; gap:1.5rem">
                                                    <form action="./edit_bayan.php" enctype="multipart/form-data" method="POST">
                                                        ...
                                                        <input type="hidden" name="file_name" value="<?php echo $row['BAYAN_FILE']; ?>">
                                                    </form>
                                                    <button class="delete" data-oldfile="<?php echo $row['BAYAN_FILE']; ?>" data-id="<?php echo $row['ID']; ?>" id="del_<?php echo $row['ID']; ?>" data-name="dele_btn" style="border: 1px solid red; border-radius: 3px; font-size: larger; background-color: #fff; padding: 0 5px;" title="Delete"><i class="fa fa-trash-o text-danger"></i></button>
                                                </div>
                                                </td>
                                            </tr>
                                            <?php
...
<!-- //////////////جدول البيبانتات ////////  -->
                ...
                <div class="row" dir="rtl">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header" style="display: flex; align-items: center; justify-content: center;">
                                <h4 class="card-title">آخر 50 بيان تمت إضافته</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display" style="min-width: 845px; color: #000;">
                                        ...
                                        <tbody id="tableBody">
                                        <?php
                                           $sql_s = 'SELECT * FROM bayan ORDER BY TRANSACTION_NUM DESC LIMIT 50';
                                           $result = mysqli_query($connect, $sql_s);
                                           if(isset($result)){
                                               $count = 1;
                                               while($row = mysqli_fetch_assoc($result)){
