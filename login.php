...
$_SESSION['last_active'] = time();
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username_err) && empty($password_err)) {
      ...
      $sql = 'SELECT ID, USERNAME_, PASSWORD_ FROM admin_login WHERE USERNAME_ = ?';
                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <div class="new-account mt-3 w-100" style="text-align: right;" dir="rtl">
                                        <p><a class="text-primary" href="./index.php">عودة إلى الصفحة الرئيسية</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
